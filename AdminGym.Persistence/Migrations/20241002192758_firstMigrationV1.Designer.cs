...
namespace AdminGym.Persistence.Migrations
{
    ...
    [Migration("20241002192758_firstMigrationV1")]
            ...
            modelBuilder.Entity("AdminGym.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(6123),
                            Description = "Permiso para consultar los datos",
                            IsActive = true,
                            Name = "Consulta",
                            PermissionType = 1,
                            UpdatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            UpdatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(6154)
                        },
                        new
                        {
                            ...
                            Consecutivo = 2L,
                            CreatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            CreatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(6162),
                            Description = "Permiso para capturar los datos",
                            IsActive = true,
                            Name = "Escritura",
                            PermissionType = 2,
                            UpdatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            UpdatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(6163)
                        },
                        new
                        {
                            ...
                            Consecutivo = 3L,
                            CreatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            CreatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(6171),
                            Description = "Permiso para editar los datos",
                            IsActive = true,
                            Name = "Modificación",
                            PermissionType = 3,
                            UpdatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            UpdatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(6172)
                        },
                        new
                        {
                            ...
                            Consecutivo = 4L,
                            CreatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            CreatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(6179),
                            Description = "Permiso para eliminar los datos",
                            IsActive = true,
                            Name = "Eliminación",
                            PermissionType = 4,
                            UpdatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            UpdatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(6181)
                        });
                });
            ...
            modelBuilder.Entity("AdminGym.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            CreatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(7577),
                            ...
                            UpdatedByUserId = new Guid("2c4c9995-bb28-48ec-b996-08dce30ff7b4"),
                            UpdatedDate = new DateTime(2024, 10, 2, 13, 27, 57, 891, DateTimeKind.Local).AddTicks(7580)
                        });
                });
